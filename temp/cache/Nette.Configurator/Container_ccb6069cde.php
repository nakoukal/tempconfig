<?php
// source: D:\XAMPP\htdocs\tempconfig\app/config/config.neon 
// source: D:\XAMPP\htdocs\tempconfig\app/config/config.local.neon 

class Container_ccb6069cde extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'Temp\Repository' => [1 => ['relremoteRepository', 'sensorsRepository', 'timetempRepository']],
			'Temp\RelremoteRepository' => [1 => ['relremoteRepository']],
			'Temp\SensorsRepository' => [1 => ['sensorsRepository']],
			'Temp\TimetempRepository' => [1 => ['timetempRepository']],
			...
			'App\Presenters\BasePresenter' => [1 => ['application.3', 'application.4', 'application.5']],
			'App\Presenters\HomepagePresenter' => [1 => ['application.3']],
			'App\Presenters\RelremotePresenter' => [1 => ['application.4']],
			'App\Presenters\TimetempPresenter' => [1 => ['application.5']],
		...
		'services' => [
			...
			'application.4' => 'App\Presenters\RelremotePresenter',
			'application.5' => 'App\Presenters\TimetempPresenter',
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'D:\XAMPP\htdocs\tempconfig\app',
			'wwwDir' => 'D:\XAMPP\htdocs\tempconfig\www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'D:\XAMPP\htdocs\tempconfig\app/../temp',
	...
	public function createServiceApplication__3()
	{
		...
		$service->inject($this->getService('sensorsRepository'));
		$service->invalidLinkMode = 5;
		return $service;
	}
	...
	/**
	 * @return App\Presenters\RelremotePresenter
	 */
	public function createServiceApplication__4()
	{
		$service = new App\Presenters\RelremotePresenter;
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('routing.router'),
		...
		$service->inject($this->getService('relremoteRepository'));
		$service->invalidLinkMode = 5;
		return $service;
	}
	...
	/**
	 * @return App\Presenters\TimetempPresenter
	 */
	public function createServiceApplication__5()
	{
		$service = new App\Presenters\TimetempPresenter;
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('routing.router'),
		...
		$service->inject($this->getService('timetempRepository'));
		$service->invalidLinkMode = 5;
		return $service;
	}
	...
	public function createServiceApplication__presenterFactory()
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'D:\XAMPP\htdocs\tempconfig\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'
		));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('D:\XAMPP\htdocs\tempconfig\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('D:\XAMPP\htdocs\tempconfig\app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=temperature', 'temp', 'pmet', null);
	...
	{
		return new Container_ccb6069cde_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	/**
	 * @return Temp\RelremoteRepository
	 */
	public function createServiceRelremoteRepository()
	{
		$service = new Temp\RelremoteRepository($this->getService('database.default.context'));
		return $service;
	}
	...
	/**
	 * @return Temp\SensorsRepository
	 */
	public function createServiceSensorsRepository()
	{
		$service = new Temp\SensorsRepository($this->getService('database.default.context'));
		return $service;
	}
	...
	/**
	 * @return Temp\TimetempRepository
	 */
	public function createServiceTimetempRepository()
	{
		$service = new Temp\TimetempRepository($this->getService('database.default.context'));
		return $service;
	}
...
class Container_ccb6069cde_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_ccb6069cde $container)
	{
	...
	public function create()
	{
		...
		$service->setTempDirectory('D:\XAMPP\htdocs\tempconfig\app/../temp/cache/latte');
